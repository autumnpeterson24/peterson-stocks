...
when writing and only having the latest stock. I also used GeeksForGeeks.com to help me out with sys.arv() to take commands from the terminal

"""

import requests # do get requests from web
from datetime import date # to get dates from last five years
import json # formatting the data to return
import sys # for argv[] and taking commands directly from terminal
